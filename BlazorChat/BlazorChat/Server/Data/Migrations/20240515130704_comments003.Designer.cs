...
namespace BlazorChat.Server.Data.Migrations
{
    ...
    [Migration("20240515130704_comments003")]
    partial class comments003
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorChat.Shared.CommentsMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("CommentsMessages");
                });

            modelBuilder.Entity("BlazorChat.Shared.PostMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BlazorChat.Shared.CommentsMessage", b =>
                {
                    b.HasOne("BlazorChat.Shared.PostMessage", "PostMessage")
                        .WithMany("Comments")
